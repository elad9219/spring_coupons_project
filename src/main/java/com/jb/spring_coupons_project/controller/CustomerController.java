...
public class CustomerController {
    ...
    public ResponseEntity<?> purchaseCoupon(@RequestHeader(name = "Authorization") String token, @PathVariable int coupon_id) throws LoginException, TokenException, CouponException, ExistsException {
