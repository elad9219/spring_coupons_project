...
public class Test2Company implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Coupon coupon1 = Coupon.builder()
                ...
                .start_date(LocalDate.of(2022, Month.OCTOBER, 22))
                .end_date(LocalDate.of(2022, Month.OCTOBER, 29))
                .amount(10)
                .price(1_249.99)
                .image("Image")
                .build();
        ...
        Coupon coupon2 = Coupon.builder()
                ...
                .start_date(LocalDate.of(2022, Month.NOVEMBER, 7))
                .end_date(LocalDate.of(2022, Month.NOVEMBER, 18))
                .amount(8)
                .price(4_379.99)
                .image("Image")
                .build();
        ...
        Coupon coupon3 = Coupon.builder()
                ...
                .start_date(LocalDate.of(2022, Month.DECEMBER, 20))
                .end_date(LocalDate.of(2022, Month.DECEMBER, 29))
                .amount(220)
                .price(99.99)
                .image("Image")
                .build();
        ...
        Coupon coupon4 = Coupon.builder()
                ...
                .start_date(LocalDate.of(2022, Month.DECEMBER, 12))
                .end_date(LocalDate.of(2023, Month.JANUARY, 30))
                .amount(20)
                .price(1639.99)
                .image("Image")
                .build();
        ...
        try {
            ...
            TablePrinter.print(companyService.getAllCompanyCouponsByMaxPrice(15.90));
        } catch (ExistsException exception) {
